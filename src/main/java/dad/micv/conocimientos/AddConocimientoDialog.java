...
public class AddConocimientoDialog extends Dialog<Conocimiento> {
    ...
    public AddConocimientoDialog() {
        try {
            FXMLLoader loader = new FXMLLoader(MiCV.class.getResource("NuevoConocimiento.fxml"));
    ...
    private Conocimiento getConverter(ButtonType button) {
        if (button.getButtonData() == ButtonBar.ButtonData.OK_DONE) {
            Conocimiento conocimiento = new Conocimiento();
            conocimiento.setDenominacion(denomProperty.get());
            conocimiento.setNivel(levelComboBox.getValue());
            return conocimiento;
        }
        return null;
    }
